...
struct Algorithms {
    ...
    static var insertionSort = Algorithm.init(id: 0, name: "Insertion sort", worstTime: "O(n^2)", avgTime: "O(n^2)", bestTime: "O(n)", worstSpace: "O(1)", avgSpace: "O(1)", bestSpace: "O(1)", wikipediaURL: "https://en.wikipedia.org/wiki/Insertion_sort", codeAlgoRythmics: "ROalU379l3U", codeHackerRank: "", codeGeeksForGeeks: "OGzPmgsI-pQ")//done
    
    static var selectionSort = Algorithm.init(id: 1, name: "Selection sort", worstTime: "O(n^2)", avgTime: "O(n^2)", bestTime: "O(n^2)", worstSpace: "fes", avgSpace: "fes", bestSpace: "fes", wikipediaURL: "fes", codeAlgoRythmics: "ywWBy6J5gz8", codeHackerRank: "SLauY6PpjW4", codeGeeksForGeeks: "PgBzjlCcFvc")
    
    static var bubbleSort = Algorithm.init(id: 2, name: "Bubble sort", worstTime: "O(n^2)", avgTime: "O(n^2)", bestTime: "O(n)", worstSpace: "fes", avgSpace: "fes", bestSpace: "fes", wikipediaURL: "fes", codeAlgoRythmics: "ywWBy6J5gz8", codeHackerRank: "SLauY6PpjW4", codeGeeksForGeeks: "PgBzjlCcFvc")
    
    static var pancakeSort = Algorithm.init(id: 3, name: "Pancake sort", worstTime: "O(n log n)", avgTime: "O(n log n)", bestTime: "fes", worstSpace: "fes", avgSpace: "fes", bestSpace: "fes", wikipediaURL: "fes", codeAlgoRythmics: "ywWBy6J5gz8", codeHackerRank: "SLauY6PpjW4", codeGeeksForGeeks: "PgBzjlCcFvc")
    
    static var heapSort = Algorithm.init(id: 4, name: "Heap sort", worstTime: "O(n log n)", avgTime: "O(n log n)", bestTime: "fes", worstSpace: "fes", avgSpace: "fes", bestSpace: "fes", wikipediaURL: "fes", codeAlgoRythmics: "ywWBy6J5gz8", codeHackerRank: "SLauY6PpjW4", codeGeeksForGeeks: "PgBzjlCcFvc")
    ...
    //static var radixSort = Algorithm.init(id: 8, name: "Counting sort", worstTime: "O(n log n)", avgTime: "O(n log n)", bestTime: "fes", worstSpace: "fes", avgSpace: "fes", bestSpace: "fes", wikipediaURL: "fes", codeAlgoRythmics: "ywWBy6J5gz8", codeHackerRank: "SLauY6PpjW4", codeGeeksForGeeks: "PgBzjlCcFvc")
    
    static var algosArray = [insertionSort, selectionSort, bubbleSort, pancakeSort, heapSort]
}
